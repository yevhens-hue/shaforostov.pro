---
title: Євген Шафоростов — AI Product Manager / Head of Product
description: AI Product Manager / Head of Product, який будує масштабовані AI-Driven продукти, FinTech & Automation. Remote.
---

# AI Product Manager / Head of Product
**Створюю масштабовані AI-Driven продукти, FinTech & Automation**
...
- **[Pitch Avatar](https://pitch-avatar.vercel.app/)** — Enterprise AI продукт (LLM аналітика, автоматизований онбординг).
- **[Telegram Analytics Dashboard](https://dashboardtelegram-analytics-qruo.vercel.app/)** — Data-driven аналітика для Telegram gambling додатків.
- **[Astro Crash Robot](https://t.me/AstroCrashRobot_bot)** — Telegram Mini App / розробка ігор.
- **[SMART iGAMING](https://www.games-income.com/all-bonuses)** — iGaming портал та агрегатор бонусів.
- **[PBN CPA](https://www.luckybetvip.com/)** — Партнерський маркетинг та Private Blog Networks.
- **[Personal Portfolio](https://github.com/yevhens-hue/shaforostov.pro)** — Open-source особистий проєкт.
...
**Вроцлав, Польща | 03/2026 – Present**

- Розширення enterprise-продукту (HR Onboarding & EdTech): керував розробкою нових ключових сутностей (Listeners, Assignments, Courses), оптимізуючи B2B шлях користувача та будуючи масштабовані цикли утримання завдяки автоматизованій доставці контенту.
- Оптимізація ARPU та монетизації: спроєктував та впровадив масштабовану багаторівневу модель білінгу (Listener Seats), що напряму пов'язує використання продукту зі зростанням доходу та покращує загальну юніт-економіку.
- Впровадження LLM-аналітики: запустив аналітичний дашборд на базі ШІ, який обробляє 50+ параметрів сесії для автоматичної генерації інсайтів (Interest Level, Lead Qualification Score), суттєво покращуючи якість data-driven рішень для клієнтів.
- Прискорення B2B зростання та інтеграції: масштабував Go-to-Market стратегію продукту завдяки безшовним двостороннім інтеграціям з основними CRM та HRIS платформами (HubSpot, Salesforce, Workday), зменшуючи операційне тертя та автоматизуючи лідогенерацію.
